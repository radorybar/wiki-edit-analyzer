package sk.fischio.wikistreamkafka.service;
...
import sk.fischio.wikistreamkafka.service.impl.ValidationServiceImpl;
...
class ValidationServiceTest {
  ...
  void isValid_withInvalidObject_returnsFalse() {
    // Arrange
    when(validator.validate(invalidWikiEvent))
        .thenReturn(java.util.Set.of(mock(jakarta.validation.ConstraintViolation.class)));
  ...
  void validate_withInvalidObject_throwsIllegalArgumentException() {
    // Arrange
    jakarta.validation.ConstraintViolation<WikiEvent> violation =
    ...
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> validationService.validate(invalidWikiEvent));

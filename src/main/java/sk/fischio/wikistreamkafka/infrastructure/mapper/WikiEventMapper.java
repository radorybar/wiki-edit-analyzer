package sk.fischio.wikistreamkafka.infrastructure.mapper;
...
/**
 * Mapper service responsible for converting between DTOs and domain models. This service helps
 * maintain a clear separation between external data representation and internal domain models.
 */
@Component
public class WikiEventMapper {
  ...
  /**
   * Converts a WikiEvent domain model to a WikimediaRecentChangeDto. This method is provided for
   * completeness but may not be used as frequently as the toWikiEvent method.
   *

...
/**
 * Service interface for producing messages to Kafka.
 * This interface defines methods for sending different types of messages to Kafka.
 */
public interface KafkaProducerService {
    ...
    /**
     * Sends a WikimediaRecentChangeDto to Kafka.
     * The DTO is converted to JSON before sending.
     *

...
/**
 * Centralized configuration properties for the Wiki Stream Kafka application.
 * This class groups related properties together and provides type-safe access to them.
 */
@Configuration
